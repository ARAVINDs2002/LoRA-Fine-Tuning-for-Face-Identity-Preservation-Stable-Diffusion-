...
This project focuses on fine-tuning a Stable Diffusion model using **LoRA** to generate images of a **specific real person** (myself), while preserving facial identity as much as possible.
...
- Different random seeds were used
...
Only **one representative image per experiment** is shared for visual reference.  
